...
public:
   ...
   void process_transaction(const chain::packed_transaction_ptr& trx, bool persist_until_expired, eosio::chain::plugin_interface::next_function<chain::transaction_trace_ptr> next); 
private:
